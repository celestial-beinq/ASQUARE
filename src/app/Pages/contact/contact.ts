...
export class ContactPage {
  ...
  faqs: FaqItem[] = [
    ...
    {
      question: 'Does A SQUARE COLLEGE offer both Day and Boarding options?',
      answer:
    ...
    {
      question: 'What curriculum does A SQUARE COLLEGE teach?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Absolutely. Guided campus tours are conducted Mondays through Fridays between 9:00 AM and 2:00 PM. Please book via this contact form or call 08053013052.',
      isOpen: false,
    },
  ];
